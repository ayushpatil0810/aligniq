  ...
  try {
    ...
    const roadmapData = await generateRoadmap({
      analysis: {
        ...
        skillsMatched: (analysis.skillsMatched as Parameters<typeof generateRoadmap>[0]['analysis']['skillsMatched']) ?? [],
        skillsMissing: (analysis.skillsMissing as Parameters<typeof generateRoadmap>[0]['analysis']['skillsMissing']) ?? [],
