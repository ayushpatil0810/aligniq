...
const features = [
	{
		...
		description:
			'AI parses your resume to extract skills, experience, and hidden gaps with precision.',
	},
	{
		icon: ChartBar,
		title: 'Semantic Match Engine',
		description:
			'Contextual AI matching — not keyword search. Understands depth, transferability, and relevance.',
	},
	{
		icon: Path,
		title: '4-Week Roadmaps',
		description:
			'Personalized learning plans targeting your exact gaps, with resources and daily practices.',
	},
	{
		icon: ChatDots,
		...
		<div className="flex min-h-screen flex-col bg-background">
			...
			<main className="flex flex-1 flex-col items-center justify-center px-6 py-24 text-center">
				...
				<p className="mt-5 max-w-md text-base text-muted-foreground leading-relaxed">
					Upload your resume. Match it against top job descriptions. Get AI-powered gap analysis, a
					personalized learning roadmap, and mock interview prep — all in one place.
				</p>
				...
				<div className="mt-8 flex items-center gap-3">
					<Link href="/auth">
						<Button
							size="lg"
							className="gap-2 bg-primary text-primary-foreground hover:bg-primary/90 h-11 px-6"
							id="btn-hero-cta"
						>
			...
			<footer className="border-t border-border/50 px-6 py-6 text-center">
				<p className="text-xs text-muted-foreground">
					© {new Date().getFullYear()} {siteConfig.name}. Built with Next.js, OpenAI, and Drizzle
					ORM.
				</p>
			</footer>
		</div>
