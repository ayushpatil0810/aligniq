...
export const ParsedResumeSchema = z.object({
  technicalSkills: z.array(z.string()).describe('Programming languages, frameworks, tools, platforms'),
  ...
  experienceLevel: z.enum(['intern', 'junior', 'mid', 'senior', 'staff']).describe('Assessed experience level'),
  ...
  missingConcepts: z.array(z.string()).describe('Common concepts typically expected but not found in resume'),
