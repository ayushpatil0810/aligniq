...
const jobs = [
  // Frontend
  {
    ...
    requirements: {
      technicalSkills: ['React', 'TypeScript', 'Next.js', 'CSS-in-JS', 'Webpack', 'Web Performance', 'A11y', 'GraphQL'],
  ...
  },
  {
    ...
    requirements: {
      technicalSkills: ['React', 'TypeScript', 'CSS', 'Performance optimization', 'WebSockets', 'IndexedDB'],
  ...
  // Backend
  {
    ...
    requirements: {
      technicalSkills: ['Ruby', 'Go', 'PostgreSQL', 'Redis', 'Kafka', 'gRPC', 'Distributed systems', 'API design'],
  ...
  },
  {
    ...
    requirements: {
      technicalSkills: ['Node.js', 'TypeScript', 'PostgreSQL', 'REST APIs', 'WebSockets', 'Docker', 'Kubernetes'],
  ...
  },
  {
    ...
    requirements: {
      technicalSkills: ['Python', 'FastAPI', 'PostgreSQL', 'Redis', 'Kubernetes', 'gRPC', 'Load balancing', 'API rate limiting'],
  ...
  },
  {
    ...
    requirements: {
      technicalSkills: ['Next.js', 'TypeScript', 'React', 'PostgreSQL', 'Prisma ORM', 'tRPC', 'Tailwind CSS'],
  ...
  // DevOps
  {
    ...
    requirements: {
      technicalSkills: ['Kubernetes', 'Terraform', 'Go', 'Prometheus', 'Grafana', 'Linux', 'BGP', 'Nginx', 'CI/CD'],
  ...
  },
  {
    ...
    requirements: {
      technicalSkills: ['Docker', 'Kubernetes', 'AWS', 'Terraform', 'Python', 'GitHub Actions', 'Helm', 'Observability'],
  ...
  // AI / ML
  {
    ...
    requirements: {
      technicalSkills: ['Python', 'PyTorch', 'CUDA', 'Distributed training', 'MLOps', 'Kubernetes', 'REST APIs', 'LLM fine-tuning'],
  ...
  },
  {
    ...
    requirements: {
      technicalSkills: ['Python', 'PyTorch', 'Transformers', 'Datasets', 'FastAPI', 'Docker', 'AWS/GCP', 'Model optimization'],
  ...
  // Data
  {
    ...
    requirements: {
      technicalSkills: ['Python', 'Apache Spark', 'dbt', 'Airflow', 'BigQuery', 'Kafka', 'SQL', 'Data modeling'],
  ...
  // Mobile
  {
    ...
    requirements: {
      technicalSkills: ['Swift', 'SwiftUI', 'UIKit', 'Combine', 'XCTest', 'Core Data', 'WebKit', 'Performance profiling'],
  ...
  },
  {
    ...
    requirements: {
      technicalSkills: ['React Native', 'TypeScript', 'Expo SDK', 'iOS', 'Android', 'Native modules', 'EAS'],
